      ...
      <Card className="border-slate-200 shadow-lg">
        <CardHeader className="space-y-2">
          ...
          <CardDescription className="text-slate-600">
            Welcome back to Switch With Me
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-slate-600 text-left pt-4 space-y-3">
                    <p>
                      I do not want to store passwords or manage password resets. Using
                      Google lets you keep your login with a provider that already handles
                      security.
                    </p>
                    <p>
                      I only store the minimum account details needed to tie your listings
                      to you—no passwords, no password recovery flows, and no extra
                      security burden.
                    </p>
